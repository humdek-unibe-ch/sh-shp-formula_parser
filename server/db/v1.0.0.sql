...
INSERT IGNORE INTO `hooks` (`id_hookTypes`, `name`, `description`, `class`, `function`, `exec_class`, `exec_function`) VALUES ((SELECT id FROM lookups WHERE lookup_code = 'hook_overwrite_return' LIMIT 0,1), 'field-formula-view', 'Output formula config - view mdoe', 'CmsView', 'create_field_item', 'FormulaParserHooks', 'outputFieldFormulaConfigView');